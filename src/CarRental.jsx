      ...
      <div className="max-w-screen-sm mx-auto px-4 pt-4 pb-24">
        ...
        {selected ? (
          <div>
            ...
            <img src={selected.image} alt={selected.title[lang]} className="w-full max-w-full h-[160px] max-h-[160px] object-cover rounded-xl mb-4" />
          ...
          <div className="flex flex-col gap-6">
            {cars.map((car) => (
              <div key={car.id} onClick={() => setSelected(car)} className="cursor-pointer bg-white rounded-xl shadow">
                <img src={car.image} alt={car.title[lang]} className="w-full max-w-full h-[140px] max-h-[160px] object-cover rounded-t-xl" />
                <div className="p-4">
